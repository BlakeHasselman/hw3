...
<div class="modal fade" id="editPlayerModal<?php echo $player['player_id']; ?>" tabindex="-1" aria-labelledby="editPlayerModalLabel<?php echo $player['player_id']; ?>" aria-hidden="true">
  ...
  <div class="mb-3">
    <label for="tID<?php echo $player['player_id']; ?>" class="form-label">Team ID</label>
    <input type="text" class="form-control" id="tID<?php echo $player['player_id']; ?>" name="tID" value="<?php echo $player['team_id']; ?>">
  </div>
  <div class="mb-3">
