...
if (isset($_POST['actionType'])) {
  switch ($_POST['actionType']) {
    case "Add":
      if (insertCoach($_POST['cName'], $_POST['cPosition'], $_POST['team_location'], $_POST['team_name'])) {
        ...
        break;
    case "Edit":
      if (updateCoach($_POST['cName'], $_POST['cPosition'], $_POST['team_location'], $_POST['team_name'])) {
