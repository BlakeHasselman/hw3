...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newTeamCoachModal">
...
<!-- Modal -->
<div class="modal fade" id="newTeamCoachModal" tabindex="-1" aria-labelledby="newTeamCoachModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newTeamCoachModalLabel">New Coach</h1>
