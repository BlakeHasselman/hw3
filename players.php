...
if (isset($_POST['actionType'])) {
  switch ($_POST['actionType']) {
    case "Add":
      if (insertPlayer($_POST['tID'], $_POST['pName'], $_POST['pPosition'], $_POST['pJersey'], $_POST['pHeight'], $_POST['pWeight'])) {
        ...
        break;
    case "Edit":
      if (updatePlayer($_POST['tID'], $_POST['pName'], $_POST['pPosition'], $_POST['pJersey'], $_POST['pHeight'], $_POST['pWeight'], $_POST['pid'])) {
